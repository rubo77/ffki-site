 ...
 * VPN - fastd Keys aktualisiert.
 * Firmware Signatur von xmaka hinzugefügt.
 ...
 * (die Config Seite ist nun auch auf französisch abrufbar) - in Kiel nicht implementiert.
 * Die Kanalbreite im 2,4Ghz Band wurde auf 20Mhz begrenzt. Dadurch werden andere 2,4Ghz Netz weniger stark beeinflusst.
 * (das AdHoc MESH arbeitet nun auch nach dem 802.11s Standard. Noch in Entwicklung) - in Kiel nicht implementiert.
